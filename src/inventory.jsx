                    ...
                    <div className={`relative flex items-center border rounded overflow-hidden transition-colors ${
                      ...
                      {p.trackingNumber && getTrackingLink(p.courier, p.trackingNumber) ? (
                          <a
                            ...
                            rel="noopener noreferrer"
                            onClick={(e) => e.stopPropagation()}
                            className="px-2 py-1 text-xs font-medium flex items-center gap-1 hover:brightness-95 hover:underline focus:outline-none text-current no-underline"
                            title={`Track ${p.courier || 'Courier'} on official site`}
                          >
